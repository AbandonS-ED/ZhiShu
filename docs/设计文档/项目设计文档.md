...
| Document Agent | 个性化文档生成 | LLM + RAG |
| MindMap Agent | 思维导图生成 | LLM + Mermaid |
| Exercise Agent | 多类型练习题生成 | LLM + 题库模板 |
| Code Agent | 代码示例生成 | LLM(代码模型) |
| Video Agent | 视频脚本/音频生成 | 讯飞有声API |
| Path Agent | 学习路径规划 | 拓扑排序 + LLM |
| Tutor Agent | 智能辅导答疑 | LLM + RAG + 防幻觉 |
