...
└── 测试说明书.md / 部署运维文档.md / 演示PPT大纲.md / 用户手册.md / AI-Coding工具使用说明.md
```
...
- **必读**：[项目设计文档-完整版.md](项目设计文档-完整版.md) —— 含完整数据库 schema、8 个 Agent 的代码骨架、API 路由、前端组件、15 天 Vertical Slice 开发计划
- **赛题约束**：[中国软件杯-A3-赛题开发需求.md](中国软件杯-A3-赛题开发需求.md) —— F1-F5 定义、评分细则、避坑点
- **开发流程**：[开发流程文档.md](开发流程文档.md) —— V1.0 12 阶段流程（与设计文档的 Vertical Slice 计划互补）
...
- **写新功能前先看**：[项目设计文档-完整版.md](项目设计文档-完整版.md) 的对应章节，骨架代码已经写好，**直接落地而非重写**。
